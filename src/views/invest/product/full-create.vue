  ...
  <div class="container-fluid">
    <div class="page-header mb-0 mt-0">
      <div class="pull-left">
        <h4>添加场馆</h4>
        <breadcrumb
                v-bind:items="[{text: '投保管理'},{text:'产品管理'},{text:'全额投保产品管理'},{text: '添加产品', active: true}]"/>
      </div>
          ...
          <div class="form-group ">
            ...
            <div class="col-lg-10">
              <label class="radio-inline">
                <input type="radio" name="generateQrCode" value="true" > 是
              </label>
              <label class="radio-inline">
                <input type="radio" name="generateQrCode" value="false"> 否
              </label>
            </div>
          </div>
        ...
        $.each($('.create-product-form'), function (i, obj) {
          $(obj).validate({
            ...
            submitHandler: function (form) {
              self.ajax({
                type: 'POST',
                url: api.invest.product.full.create.url,
