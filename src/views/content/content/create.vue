  ...
  <div class="container-fluid">
    <div class="page-header mb-0 mt-0">
      <div class="pull-left">
        <h4>内容管理</h4>
        <breadcrumb
                v-bind:items="[{text: '内容管理'},{text:'新闻资讯管理'},{text:'内容管理'},{text: '添加内容', active: true}]"/>
      </div>
          ...
          <div class="form-group">
            ...
            <div class="col-lg-10">
              <label class="radio-inline">
                <input type="radio" name="pcVisible" value="1" checked="checked"> 显示
              </label>
              <label class="radio-inline">
                <input type="radio" name="pcVisible" value="0"> 不显示
              </label>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-lg-10">
              <label class="radio-inline">
                <input type="radio" name="appVisible" value="1" checked="checked"> 显示
              </label>
              <label class="radio-inline">
                <input type="radio" name="appVisible" value="0"> 不显示
              </label>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-lg-10">
              <label class="radio-inline">
                <input type="radio" name="wechatVisible" value="1" checked="checked"> 显示
              </label>
              <label class="radio-inline">
                <input type="radio" name="wechatVisible" value="0"> 不显示
              </label>
            </div>
          </div>
          <div class="form-group">
        ...
        $.each($('.create-category-form'), function (i, obj) {
          $(obj).validate({
            ...
            submitHandler: function (form) {
              self.ajax({
                type: 'POST',
                url: api.content.content.create.url,
