  ...
  <div class="container-fluid">
    <div class="page-header mb-0 mt-0">
      <div class="pull-left">
        <h4>会员管理</h4>
        <breadcrumb
                v-bind:items="[{text: '用户管理'},{text:'会员管理'},{text: '添加用户', active: true}]"/>
      </div>
    ...
    <div class="panel panel-white">
      <div class="panel-body">
        <h4>添加用户</h4>
        <hr>
        <form class="form-horizontal mt-2 create-holder-form" method="post" novalidate="novalidate">
...
<script>
  ...
  export default{
    ...
    methods: {
      submitForm: function () {
        let self = this;
        $.each($('.create-holder-form'), function (i, obj) {
          $(obj).validate({
            rules: {
              userName: {
                required: true
