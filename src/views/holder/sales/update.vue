  ...
  <div class="container-fluid">
    <div class="page-header mb-0 mt-0">
      <div class="pull-left">
        <h4>会员管理</h4>
        <breadcrumb
                v-bind:items="[{text: '用户管理'},{text:'客户经理管理'},{text: '编辑客户经理', active: true}]"/>
      </div>
...
<script>
  ...
  export default{
    ...
    methods: {
      ...
      setInitValueArea: function () {
        let self = this;
        commonApp.tools.resetSelect2Option({
          $select: $('#areaId'),
          initValue: self.holder.areaId,
          url: api.content.area.get.url(self.holder.areaId),
          idFieldName: 'area.id',
