  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-white">
      <div class="panel-body">
        <form class="form-inline dk-search-list-bar store-invest-form">
...
<script>
  ...
  export default{
    ...
    methods: {
      getStoreInvest: function (data) {
        let self = this;
        self.ajax({
          url: api.statistic.storeInvest.url,
          data: data,
      ...
      search: function (data) {
        ...
        let formData = commonApp.tools.getFromData($('.store-invest-form'));
        _.assign(data, formData);
        this.getStoreInvest(data);
      },
    },
    watch: {
